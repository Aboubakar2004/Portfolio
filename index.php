...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            <a href="#home" class="active">Accueile</a>
    ...
    <section class="about" id="about">
        ...
        <div class="about-content">
            ...
            <a href="https://www.linkedin.com/in/aboubakar-bamba-5b2279274/" class="btn">En savoir plus</a>
        </div>
    </section>
    ...
    <section class="services" id="services">
        ...
        <div class="services-container">
            <div class="services-box">
                ...
                <a href="https://www.hetic.net/formations/bachelor-web/programme-bachelor-web" class="btn">En savoir plus</a>
            </div>
            ...
            <div class="services-box">
                ...
                <a href="https://www.hetic.net/formations/grande-ecole" class="btn">En savoir plus</a>
            </div>
        ...
        <div class="portfolio-container">
            <div class="portfolio-box">
                ...
                <div class="portfolio-layer">
                    ...
                    <a href="https://aboubakar-bamba-weather-app.netlify.app/"><i class="bx bx-link-external"></i></a>
                </div>
            </div>
    ...
    <section class="contact" id="contact">
        ...
        <form action="" method="post">
            ...
            <input type="submit" value="Envoyer votre message" class="btn" name="ok" />
        </form>
    </section>
